        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/dapr.proto.runtime.v1.AppCallback/OnBulkTopicEvent" => {
                    #[allow(non_camel_case_types)]
                    struct OnBulkTopicEventSvc<T: AppCallback>(pub Arc<T>);
                    impl<
                        T: AppCallback,
                    > tonic::server::UnaryService<super::TopicEventBulkRequest>
                    for OnBulkTopicEventSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AppCallback>::on_bulk_topic_event(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
...
pub struct TryLockRequest {
    ...
    /// 1. If we change the field 'my_lock_owner_id' in the response to 'lock_owner',which means the current lock owner of this lock,
    ///    we find that in some lock services users can't get the current lock owner.Actually users don't need it at all.
    /// 1. When reentrant lock is needed,the existing lock_owner is required to identify client and check "whether this client can reenter this lock".
...
pub mod dapr_server {
    ...
    pub trait Dapr: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn unregister_actor_reminders_by_type(
            &self,
            request: tonic::Request<super::UnregisterActorRemindersByTypeRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UnregisterActorRemindersByTypeResponse>,
            tonic::Status,
        >;
        async fn list_actor_reminders(
            &self,
            request: tonic::Request<super::ListActorRemindersRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListActorRemindersResponse>,
            tonic::Status,
        >;
        ...
        >;
        /// Gets an actor reminder.
        async fn get_actor_reminder(
            &self,
            request: tonic::Request<super::GetActorReminderRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetActorReminderResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/dapr.proto.runtime.v1.Dapr/BulkPublishEvent" => {
                    #[allow(non_camel_case_types)]
                    struct BulkPublishEventSvc<T: Dapr>(pub Arc<T>);
                    impl<T: Dapr> tonic::server::UnaryService<super::BulkPublishRequest>
                    for BulkPublishEventSvc<T> {
                        type Response = super::BulkPublishResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Dapr>::bulk_publish_event(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = BulkPublishEventSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/dapr.proto.runtime.v1.Dapr/UnregisterActorRemindersByType" => {
                    #[allow(non_camel_case_types)]
                    struct UnregisterActorRemindersByTypeSvc<T: Dapr>(pub Arc<T>);
                    impl<
                        T: Dapr,
                    > tonic::server::UnaryService<
                        super::UnregisterActorRemindersByTypeRequest,
                    > for UnregisterActorRemindersByTypeSvc<T> {
                        type Response = super::UnregisterActorRemindersByTypeResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Dapr>::unregister_actor_reminders_by_type(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UnregisterActorRemindersByTypeSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/dapr.proto.runtime.v1.Dapr/ListActorReminders" => {
                    #[allow(non_camel_case_types)]
                    struct ListActorRemindersSvc<T: Dapr>(pub Arc<T>);
                    impl<
                        T: Dapr,
                    > tonic::server::UnaryService<super::ListActorRemindersRequest>
                    for ListActorRemindersSvc<T> {
                        type Response = super::ListActorRemindersResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Dapr>::list_actor_reminders(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListActorRemindersSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/dapr.proto.runtime.v1.Dapr/GetActorReminder" => {
                    #[allow(non_camel_case_types)]
                    struct GetActorReminderSvc<T: Dapr>(pub Arc<T>);
                    impl<
                        T: Dapr,
                    > tonic::server::UnaryService<super::GetActorReminderRequest>
                    for GetActorReminderSvc<T> {
                        type Response = super::GetActorReminderResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Dapr>::get_actor_reminder(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetActorReminderSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/dapr.proto.runtime.v1.Dapr/DeleteJobsByPrefixAlpha1" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteJobsByPrefixAlpha1Svc<T: Dapr>(pub Arc<T>);
                    impl<
                        T: Dapr,
                    > tonic::server::UnaryService<super::DeleteJobsByPrefixRequestAlpha1>
                    for DeleteJobsByPrefixAlpha1Svc<T> {
                        type Response = super::DeleteJobsByPrefixResponseAlpha1;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::DeleteJobsByPrefixRequestAlpha1,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Dapr>::delete_jobs_by_prefix_alpha1(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteJobsByPrefixAlpha1Svc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/dapr.proto.runtime.v1.Dapr/ListJobsAlpha1" => {
                    ...
                    impl<
                        T: Dapr,
                    > tonic::server::UnaryService<super::ListJobsRequestAlpha1>
                    for ListJobsAlpha1Svc<T> {
                        type Response = super::ListJobsResponseAlpha1;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Dapr>::list_jobs_alpha1(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
