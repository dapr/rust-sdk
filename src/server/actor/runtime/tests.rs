...
// use crate::{server::actor::Actor, actor};
...
//     fn new(actor_type: &str, actor_id: &str, context: ActorContextClient) -> Arc<dyn Actor> {
//         Arc::new(MyActor::new(actor_id))
//     }
...
//     let mut runtime = ActorRuntime::new(Arc::new(FakeActorClient {}));
//     runtime.register_actor(
//         ActorTypeRegistration::new::<MyActor>("MyActor")
